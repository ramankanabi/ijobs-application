library dropdownraman;

import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

///DropDownRaman has customized autocomplete text field functionality
///
///Parameters
///
...
class DropDownRaman extends FormField<String> {
  final dynamic value;
  final Widget icon;
  ...
  DropDownRaman(
      ...
      : super(
          ...
          builder: (FormFieldState<String> field) {
            final DropDownRamanState state = field;
  ...
  @override
  DropDownRamanState createState() => DropDownRamanState();
}

class DropDownRamanState extends FormFieldState<String> {
  ...
  @override
  DropDownRaman get widget => super.widget;
  ...
  @override
  void didUpdateWidget(DropDownRaman oldWidget) {
